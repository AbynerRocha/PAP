  ...
  return (
    <View className='bg-blue-800 h-full w-full'>
      ...
      <ScrollView className='flex-1 bg-slate-50'>
          ...
          isFetchingFrequency || isLoadingFrequency
            ...
            : errorFrequency
              ...
              : <View className='flex-row items-center mt-10'>
                ...
                <View className='w-[1] h-[155px] bg-slate-200 ml-2'/>
              ...
              : <View className='w-[80%] h-[150px] items-center justify-center'>
                  <Text className='text-lg font-semibold text-slate-300 -rotate-45'>Sem dados</Text>
              </View>
              }
              </View>
        }
        ...
        <View className='w-[75%] h-[1] bg-slate-200' />
        </View>
      ...
      >
        ...
        <View className='h-fit w-[75%] absolute -bottom-0 left-24 justify-start items-start'>
          ...
          <Text className='text-slate-50 text-xl font-medium mb-2'>{renderName()}</Text>
        </View>
      </View>
    </View>
  )
